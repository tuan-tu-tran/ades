...
<a href="index.php">
<img src="images/retour.gif" title="retour � l'index" alt="Retour � l'index"
border="0" class="inv" style="float: right">
</a>
<a href="#">
<img src="images/prec.gif" border="0" title="Page pr�c�dente" alt="Page pr�c�dente"
...
?>
	<ul class="navlist inv">
		<li>
		<a href="index.php">
		<img src="images/home.png" class="icone" alt="Accueil"></a>
		</li>
		<li>
		<a href="mail.php">
		<img src="images/minimail.png" class="icone" alt="."><b>
		<?php
		
		include_once("ADESminimail.class.php");
		$ADESminimail= new ADESminimail;
		$ADESminimail->connectDB();
		echo $ADESminimail->get_nbrlu_minimail();
		...
		Par pr&eacute;nom</a>
			...
			if (utilisateurParmi("educ", "admin"))
				{
				echo "<li>\n<a href=\"ficheel.php?mode=nouveau\" ";
				echo "title=\"Ajouter un &eacute;l&eagrave;ve\">";
				echo "<img src=\"images/nouveau.png\" class=\"icone\" alt=\".\">";
				echo "Nouveau</a>\n</li>\n";
				}
			?>
			</ul>
		...
		<li><a href="#"><img class="icone" src="images/retenue.png" alt=".">Retenues</a>
			<ul>
			<li>
			<a href="listeretenues.php" title="Liste des �l�ves en retenue 
				(par date)">
