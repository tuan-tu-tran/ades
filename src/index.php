...
//Rami Adrien
//Classe qui va permettre la gestion des m�mos de l'utilisateur
require ("ADEStodo.class.php");
//On cr�er un objet ADEStodo
...
<?php
/*Rami Adrien
 * Les fonctionnalit�s de d�part on �t� d�plac� dans respectivement dans:
 * Synth�se (pour dire le nombre d'�l�ves actuellement trait�
 * Backup, pour dire quelle est le dernier backup
 * La fonction permettant d'afficher les f�tes a �t� simplifi� et n'utilise pas l'option
 * du str replace avec le fichier text index.inc.htm
 */

//On r�cup�re la date et l'heure
$date = date("d/m/Y");
$heure = date("H:i");
$dateAnniv = date ("d/m");
//On se connecte � la db
...
// recherche de toutes les classes et tous les �l�ves existants dans la base de donn�es
